...
import { Loader2, Pencil, CheckCircle2, Save, X } from "lucide-react";
        ...
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
              ...
              <input
                ...
                className={`w-full rounded-lg border px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition-colors ${
                  !isEditing 
              ...
              <div className="flex items-center justify-between mb-1">
                ...
                {isEditing && (
                  <span className={`text-xs font-medium ${
                    form.clabe.length === 18 ? "text-green-600" : "text-text-muted"
                  }`}>
          ...
          <div>
            ...
            <textarea
              ...
              className={`w-full rounded-lg border px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition-colors resize-none ${
                !isEditing 
                  ? "bg-background border-transparent text-text-primary cursor-default" 
                  : "bg-white border-border text-text-primary"
              }`}
